...
const config = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      CDN_HOST: RELEASE ? 'cdn.dreamhiway.com' : JSON.stringify('192.168.2.10:81'),
      MAIN_HOST: RELEASE ? 'www.dreamhiway.com' : JSON.stringify('192.168.2.177:8085'),
      HR_HOST: RELEASE ? 'hr.dreamhiway.com' : JSON.stringify('192.168.2.177:8086'),
      ZC_HOST: RELEASE ? 'zc.dreamhiway.com' : JSON.stringify('192.168.2.177:8088'),
      ZB_HOST: RELEASE ? 'zb.dreamhiway.com' : JSON.stringify('192.168.2.177:8090'),
      ZCKJ_HOST: RELEASE ? 'zckj.dreamhiway.com' : JSON.stringify('192.168.2.177:8091'),
      DIY_HOST: RELEASE ? 'diy.dreamhiway.com' : JSON.stringify('192.168.2.177:8092'),
      SRDZ_HOST: RELEASE ? 'srdz.dreamhiway.com' : JSON.stringify('192.168.2.177:8093'),
      KJ_HOST: RELEASE ? 'kj.dreamhiway.com' : JSON.stringify('192.168.2.177:8087'),
      'process.env': {
